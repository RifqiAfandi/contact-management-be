...
router.post('/users', authenticateToken, isAdmin, uploader.single('image'), AuthController.createUser);
...
router.put('/users/:id', authenticateToken, isAdmin, uploader.single('image'), AuthController.updateUser);
